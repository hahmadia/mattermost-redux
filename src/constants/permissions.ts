...
const values = {
    ...
    SYSCONSOLE_READ_BILLING_SUBSCRIPTION: 'sysconsole_read_billing_subscription',
    SYSCONSOLE_WRITE_BILLING_SUBSCRIPTION: 'sysconsole_write_billing_subscription',
    SYSCONSOLE_READ_BILLING_BILLING_HISTORY: 'sysconsole_read_billing_billing_history',
    SYSCONSOLE_WRITE_BILLING_BILLING_HISTORY: 'sysconsole_write_billing_billing_history',
    SYSCONSOLE_READ_BILLING_COMPANY_INFORMATION: 'sysconsole_read_billing_company_information',
    SYSCONSOLE_WRITE_BILLING_COMPANY_INFORMATION: 'sysconsole_write_billing_company_information',
    SYSCONSOLE_READ_BILLING_PAYMENT_INFORMATION: 'sysconsole_read_billing_payment_information',
    SYSCONSOLE_WRITE_BILLING_PAYMENT_INFORMATION: 'sysconsole_write_billing_payment_information',
...
values.SYSCONSOLE_READ_PERMISSIONS = [
    ...
    values.SYSCONSOLE_READ_BILLING_SUBSCRIPTION,
    values.SYSCONSOLE_READ_BILLING_BILLING_HISTORY,
    values.SYSCONSOLE_READ_BILLING_COMPANY_INFORMATION,
    values.SYSCONSOLE_READ_BILLING_PAYMENT_INFORMATION,
...
values.SYSCONSOLE_WRITE_PERMISSIONS = [
    ...
    values.SYSCONSOLE_WRITE_BILLING_SUBSCRIPTION,
    values.SYSCONSOLE_WRITE_BILLING_BILLING_HISTORY,
    values.SYSCONSOLE_WRITE_BILLING_COMPANY_INFORMATION,
    values.SYSCONSOLE_WRITE_BILLING_PAYMENT_INFORMATION,
